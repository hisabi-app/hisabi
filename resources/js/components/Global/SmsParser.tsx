...
export default function SmsParser({ onClose }: SmsParserProps) {
  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden">
      {/* Header */}
      <div className="border-b p-4 border-r">
      ...
      <div className="border-t border-r p-4 bg-background">
        <div className="space-y-3">
          {/* Date Input - Absolute positioned at bottom right corner */}
          ...
          <div>
            <textarea
              ...
              className="w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm p-3 resize-none"
              rows={4}
              placeholder="Paste SMS messages here (one per line for multiple messages)..."
            />
          </div>
